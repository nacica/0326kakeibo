import {
  ...
  import { ExpenseCategory, IncomeCategory, Transaction } from "../types/17index";
  ...
  import { Schema, transactionSchema } from "../validations/20schema";
  ...
  const TransactionForm = ({
    ...
    //フォーム内容を更新　クリックした取引のデータをフォームに表示
    useEffect(() => {
      if (selectedTransaction) {
